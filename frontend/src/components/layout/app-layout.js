      ...
      <AppBar position="static" sx={{ backgroundColor: "red" }}>
        <Container maxWidth="xl">
          <Toolbar disableGutters>
            <img src="https://tse2.mm.bing.net/th?id=OIP.OsrxHIwHilMwVPW9afUDegAAAA&pid=Api&P=0&h=180" style={{ width: "50px", margin: "10px" }} />
            <Link to="/" style={{ textDecoration: "none", flexGrow: 1 }}>
              ...
              >
                P.E.S Modern College Of Engineering (MCA Department)
              </Typography>
            </Link>
            <Box
              sx={{
